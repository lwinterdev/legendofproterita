...
var room_name = "VillageOfThings"

var save_path = "user://room_configs/VIllageOfThings.ini"
...
func _ready():
	...
	if GlobalRoomHandler.village_of_things_new== false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.village_of_things_new = false
