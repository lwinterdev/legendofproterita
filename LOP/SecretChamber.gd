...
var room_name = "SecretChamber"

var save_path = "user://room_configs/SecretChamber.ini"
...
func _ready():
	...
	if GlobalRoomHandler.secret_chamber_new == false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.secret_chamber_new = false
