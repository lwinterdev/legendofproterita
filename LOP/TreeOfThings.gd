...
var room_name = "TreeOfThings"

var save_path = "user://room_configs/TreeOfThings.ini"
...
func _ready():
	...
	if GlobalRoomHandler.tree_of_things_new== false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.tree_of_things_new = false
