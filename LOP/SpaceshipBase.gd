...
var room_name = "SpaceshipBase"

var save_path = "user://room_configs/SpaceshipBase.ini"
...
func _ready():
	...
	if GlobalRoomHandler.spaceship_base_new == false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.spaceship_base_new = false
