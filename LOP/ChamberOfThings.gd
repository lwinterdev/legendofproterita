...
var room_name = "ChamberOfThings"

var save_path = "user://room_configs/ChamberfThings.ini"
...
func _ready():
	...
	if GlobalRoomHandler.swamp_of_things_new== false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.chamber_of_things_new = false
