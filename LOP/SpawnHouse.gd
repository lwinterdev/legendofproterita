...
var room_name = "SpawnHouse"

var save_path = "user://room_configs/spawn_house.ini"
...
func _ready():
	...
	if GlobalRoomHandler.spawn_house_new == false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.spawn_house_new = false
