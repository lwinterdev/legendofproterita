...
var room_name = "PlaceOfComfort"

var save_path = "user://room_configs/PlaceOfComfort.ini"
...
func _ready():
	...
	if GlobalRoomHandler.place_of_comfort_new == false:
		GlobalRoomHandler.load_room(self,save_path,player)
		
	GlobalRoomHandler.place_of_comfort_new = false
